...
class itinerary_detail extends Model
{
    ...
    protected $fillable = [
							'id', 'dt', 'code', 'booked_by','seat', 'seat_remain', 'start', 'end', 'adult_price', 'child_price', 'child_bed_price', 'infant_price', 'minimal_dp', 'agent_com','staff_com', 'agent_tip', 'agent_visa', 'agent_tax', 'final_pdf', 'term_pdf', 'flayer_jpg', 'tour_leader_id','tour_leader_tips', 'created_by', 'updated_by', 'created_at', 'updated_at','flight_detail','gross_per_pax'
    					];
