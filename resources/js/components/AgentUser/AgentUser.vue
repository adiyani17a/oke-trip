...
<script>
    ...
    Vue.component('create-agent-user', require('./CreateAgentUser.vue').default)
    ...
    export default {
        mounted() {
            ...
            let breadcrumb = '<router-link to="/agent-user">Agent User</router-link>';
        ...
        methods:{
            onClickChild(value){
                this.api = '/api/agent-user/datatable'
            },
            ...
            callingApi(page,show){
                ...
                axios
                  .get('/api/agent-user/datatable?page='+page+'&showing='+show)
                  .then(response => {
            ...
            switchChange(data,id,param){
                axios
                    .post('/api/agent-user/change-status',{
                        data:data,
                        id:id,
                        param:param,
                    })
