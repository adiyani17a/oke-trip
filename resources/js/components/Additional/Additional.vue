            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <create-additional :dialog="dialog" 
                                            :idData="idData" 
                                            :options="options"
                                            @closeDialog="closeDialog"></create-additional>
                    </div>
                    <v-dialog
...
<script>
    ...
    Vue.component('create-additional', require('./CreateAdditional.vue').default)
