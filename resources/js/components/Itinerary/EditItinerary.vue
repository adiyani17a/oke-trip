            ...
            <form-wizard title="" subtitle="" @on-loading="setLoading" color="#007bff" error-color="red" finish-button-text="Save" @on-complete="onComplete">
              <tab-content title="Form Data" :before-change="beforeChange">
                <v-layout wrap>
                  ...
                  <v-flex xs12 md6 style="padding: 10px">
                    <v-text-field label="Highlight*" v-model="form.highlight" required name="highlight" @blur="$v.form.highlight.$touch()" :error-messages="highlightErrors"></v-text-field>
                  </v-flex>
                  <v-flex xs12 md6 style="padding: 10px">
  ...
  export default {
      ...
      computed: {
          ...
          staffPriceErrors() {
              ...
              !this.$v.formDetail.staffPrice.required && errors.push('Staff Com Price is required.')
              return errors
          },
      },
      props: {
      ...
      methods: {
          ...
          callingApi(){
            axios
              .get('/api/itinerary/edit/'+this.$route.params.id)
              .then(response => {
                ...
                this.contentModel = response.data.data.term_condition

                this.$refs.carousel[0].images.push(response.data.data.carousel1);
                this.$refs.carousel[1].images.push(response.data.data.carousel2);
                this.$refs.carousel[2].images.push(response.data.data.carousel3);
                this.$refs.pdf.images.push(response.data.data.pdfs);
                this.$refs.flyer.images.push(response.data.data.flayer_images);

                this.form.note[0] = response.data.data.note_1;
                ...
                for (var i = 0; i < response.data.data.itinerary_detail.length; i++) {
                  let data = {
                    ...
                    'CwBPrice':response.data.data.itinerary_detail[i].child_bed_price,
                    'CnBPrice':response.data.data.itinerary_detail[i].child_price,
                    'infantPrice':response.data.data.itinerary_detail[i].infant_price,
                    'agentPrice':response.data.data.itinerary_detail[i].agent_com,
                    'staffPrice':response.data.data.itinerary_detail[i].staff_com,
                    'tipsPrice':response.data.data.itinerary_detail[i].agent_tip,
                    'visaPrice':response.data.data.itinerary_detail[i].agent_visa,
                    'aptPrice':response.data.data.itinerary_detail[i].agent_tax,
                    'seat':response.data.data.itinerary_detail[i].seat_remain,
