...
<script>
    ...
    Vue.component('create-administrator-user', require('./CreateAdministratorUser.vue').default)
    ...
    export default {
        mounted() {
            ...
            let breadcrumb = '<router-link to="/administrator-user">Administrator User</router-link>';
        ...
        methods:{
            onClickChild(value){
                this.api = '/api/administrator-user/datatable'
            },
            ...
            deleteData(){
                ...
                axios
                    .delete('/api/administrator-user/delete',{
                        data:{
                            data:this.select,
                        }
                    })
            ...
            switchChange(data,id,param){
                axios
                    .post('/api/administrator-user/change-status',{
                        data:data,
                        id:id,
                        param:param,
                    })
