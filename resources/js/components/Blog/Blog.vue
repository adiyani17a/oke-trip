            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <create-blog :dialog="dialog" 
                                            :idData="idData" 
                                            @closeDialog="closeDialog"></create-blog>
                    </div>
                    <v-dialog
...
<script>
    ...
    Vue.component('create-blog', require('./CreateBlog.vue').default)
    ...
    export default {
        mounted() {
            ...
            let breadcrumb = '<router-link to="/blog">Blog</router-link>';
        ...
        methods: {
            ...
            callingApi(page, show) {
                ...
                axios
                    .get('/api/blog/datatable?page=' + page + '&showing=' + show)
                    .then(response => {
