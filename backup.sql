...
CREATE TABLE IF NOT EXISTS `itinerary` (
  ...
  `active` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hot_deals` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
REPLACE INTO `itinerary` (`id`, `code`, `name`, `destination_id`, `highlight`, `term_condition`, `flight_by`, `additional_id`, `carousel_1`, `carousel_2`, `carousel_3`, `note_1`, `note_2`, `note_3`, `pdf`, `flayer_image`, `book_by`, `active`, `hot_deals`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table oke_trip.migrations: ~23 rows (approximately)
...
REPLACE INTO `token_management` (`id`, `user_id`, `access_token`, `expired_at`, `is_active`, `created_at`, `updated_at`) VALUES
	...
	(2099, 3, 'ZDA3MWFmMjViZTMwYjJmYmY0OWViYTJlZmRlODE5ZGYwNTdlODk5Yw==', '2019-09-04 11:12:04', 1, '2019-09-03 11:12:04', '2019-09-03 11:12:04'),
	(2100, 3, 'MzRkYjgwZDEzMDE3NTdmZmYyY2U5YjU4ODViOTI5NWQ0NTc2MGMzMw==', '2019-09-04 11:40:51', 1, '2019-09-03 11:40:51', '2019-09-03 11:40:51');
